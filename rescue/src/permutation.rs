//! Rescue Pseudorandom Permutation (PRP) implementation for the BLS12_381
//! Scalar field with 4 elements as key and input size. From the PRP it derives
//! 3 hash functions: 1. Sponge construction with arbitrary input and output
//! length 2. Sponge construction with input length multiple of the RATE (3) (no
//! padding needed) 3. 3 to 1 hashing (same construction as 1 and 2, but
