...
use crate::{
    circuit::{customized::next_multiple, Circuit, PlonkCircuit, Variable},
    ...
    F: PrimeField,
{
    ...
    pub fn new(p: &F, m: usize, two_power_m: Option<F>) -> Result<Self, PlonkError> {
...
impl<F: PrimeField> FpElemVar<F> {
    ...
    /// witness[vars.1]`
    pub fn convert_to_var(&self, cs: &mut PlonkCircuit<F>) -> Result<Variable, PlonkError> {
        cs.lc(
    ...
    pub fn witness_fp_elem(&self, cs: &PlonkCircuit<F>) -> Result<FpElem<F>, PlonkError> {
        Ok(FpElem {
    ...
    pub fn witness(&self, cs: &PlonkCircuit<F>) -> Result<F, PlonkError> {
...
impl<F: PrimeField> PlonkCircuit<F> {
    ...
    pub fn mod_negate(&mut self, x: &FpElemVar<F>, p: &F) -> Result<FpElemVar<F>, PlonkError> {
        let range_bit_len = self.range_bit_len()?;
        ...
        let x_int = &x0_int + &two_power_m_int * &x1_int;
        if x_int >= p_int {
            return Err(PlonkError::NonNativeFieldOverflow);
        }
...
mod test {
    use super::*;
    use crate::circuit::customized::test::test_variable_independence_for_circuit;
    ...
    #[test]
    fn test_fp_elem() -> Result<(), PlonkError> {
    ...
    fn test_fp_elem_helper<F: PrimeField>() -> Result<(), PlonkError> {
    ...
    #[test]
    fn test_fp_elem_var() -> Result<(), PlonkError> {
    ...
    fn test_fp_elem_var_helper<F: PrimeField>() -> Result<(), PlonkError> {
    ...
    #[test]
    fn test_mod_add_internal() -> Result<(), PlonkError> {
    ...
    fn test_mod_add_internal_helper<F: PrimeField>() -> Result<(), PlonkError> {
        let mut circuit: PlonkCircuit<F> = PlonkCircuit::new_ultra_plonk(RANGE_BIT_LEN_FOR_TEST);
    ...
    // ========================================
    #[test]
    fn test_mod_mul() -> Result<(), PlonkError> {
    ...
    // ========================================
    #[test]
    fn test_mod_add_constant() -> Result<(), PlonkError> {
    ...
    // ========================================
    #[test]
    fn test_mod_negation() -> Result<(), PlonkError> {
