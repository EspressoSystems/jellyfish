...
impl<F: PrimeField> PlonkCircuit<F> {
    ...
    pub(crate) fn range_gate_with_lookup(
        ...
        if bit_len == 0 {
            return Err(ParameterError("bit_len cannot be zero".to_string()).into());
        }
    ...
    #[inline]
    pub fn num_range_blocks(&self) -> Result<usize, PlonkError> {
...
mod test {
    ...
    #[test]
    fn test_range_gate_with_lookup() -> Result<(), PlonkError> {
    ...
    fn test_range_gate_with_lookup_helper<F: PrimeField>() -> Result<(), PlonkError> {
