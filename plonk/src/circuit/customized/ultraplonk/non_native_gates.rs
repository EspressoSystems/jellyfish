...
mod test {
    ...
    #[test]
    fn test_non_native_power_11_gen() -> Result<(), PlonkError> {
        // use bls12-377 base field to prove rescue over jubjub377 base field
        test_non_native_power_11_gen_helper::<FqEd377, Fq377>()
    }

    fn test_non_native_power_11_gen_helper<T: PrimeField, F: PrimeField>() -> Result<(), PlonkError>
    {
    ...
    #[test]
    fn test_non_native_power_5_gen() -> Result<(), PlonkError> {
        // use bls12-377 base field to prove rescue over jubjub377 base field
        test_non_native_power_5_gen_helper::<FqEd377, Fq377>()
    }

    fn test_non_native_power_5_gen_helper<T: PrimeField, F: PrimeField>() -> Result<(), PlonkError>
    {
        let mut circuit: PlonkCircuit<F> = PlonkCircuit::new_ultra_plonk(RANGE_BIT_LEN_FOR_TEST);
    ...
    #[test]
    fn test_non_native_power_11_gate() -> Result<(), PlonkError> {
        // use bls12-377 base field to prove rescue over bls scalar field
        test_non_native_power_11_gate_helper::<FqEd377, Fq377>()
    }

    fn test_non_native_power_11_gate_helper<T: PrimeField, F: PrimeField>() -> Result<(), PlonkError>
    {
        let mut circuit: PlonkCircuit<F> = PlonkCircuit::new_ultra_plonk(RANGE_BIT_LEN_FOR_TEST);
    ...
    fn test_non_native_linear_gate_helper<T: PrimeField, F: PrimeField>() -> Result<(), PlonkError>
    {
        let mut circuit: PlonkCircuit<F> = PlonkCircuit::new_ultra_plonk(RANGE_BIT_LEN_FOR_TEST);
